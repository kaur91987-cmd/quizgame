...
- How to reach me **kaur91987@gmail.com**

- Know about my experiences [fresher](fresher)

<p>Passionate and dedicated PHP developer focused on building secure, dynamic, and user-friendly web applications. I enjoy solving real-world problems using clean backend logic and structured database design.</p>
...
<ul>
  ...
  <li>Score Calculation System</li>
  ...
  <li>Database-driven questions</li>
...
<ol>
  ...
  <li>Create a new database: <code>quiz_game</code></li>
...
<h1>How It Works</h1>
<ol>
  <li>User registers an account</li>
  <li>Login to dashboard</li>
  <li>Select difficulty level (Basic / Medium / High)</li>
...
<ul>
  ...
  <li>Protected quiz pages (only logged-in users can access)</li>
</ul>
<h1>Screenshots</h1>
